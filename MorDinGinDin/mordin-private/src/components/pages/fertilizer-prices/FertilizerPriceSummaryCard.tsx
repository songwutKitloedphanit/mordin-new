...
const FertilizerPriceSummaryCard = () => {
  ...
  return (
    <div className="row">
      ...
      <GenCard1
        ...
        num={summary.majorAvgPricePerSack}
        name="บาทต่อกระสอบ"
      ...
      <GenCard1
        color="bg-info"
        icon="fas fa-money-bill-alt"
        num={summary.minorAvgPricePerKg}
        name="บาทต่อกิโลกรัม"
        desc="ราคาธาตุอาหารรองเฉลี่ย"
      />
    </div>
  );
};

export default FertilizerPriceSummaryCard;
