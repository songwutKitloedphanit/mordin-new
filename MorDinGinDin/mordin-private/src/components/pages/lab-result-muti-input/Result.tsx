...
export const ResultComponent: React.FC<{
  ...
  const handleSubmit = async () => {
    ...
    // BLANK → /analysis-standard-results/input (resultId = "blank:<analysisStandardResultId>")
    ...
    // CRM CERTIFICATE → /standard-certificates/input (resultId = "crmcert:<standardId>:<laboratoryId>")
