...
import MapMarkerFix from '@/components/map/MapMarkerFix';
        ...
        <div className="card-header">
          <div className="row row-demo-grid">
            <div className="col-md-8 col-sm-8 col-8 text-start">
              <h4 className="card-title">Print QR code</h4>
            </div>
          </div>
        </div>
...
const AnalysisReportInfo = () => {
  ...
  const fetchReport = async () => {
    ...
    if (sampleCode) {
      ...
      setLocation([
        {
          id: data[0].land?.landId || 0,
          lat: Number(data[0].land?.latitude),
          lng: Number(data[0].land?.longitude),
        },
      ]);
    }
                    ...
                    <table style={{ minHeight: '205px' }}>
                      <tbody>
                        ...
                        <tr>
                          <th>พิกัด</th>
                          <td>
                            {reportData.land?.latitude},
                            {reportData.land?.longitude}
                          </td>
                        </tr>
                        <tr>
                          <td colSpan={2}>&nbsp;</td>
