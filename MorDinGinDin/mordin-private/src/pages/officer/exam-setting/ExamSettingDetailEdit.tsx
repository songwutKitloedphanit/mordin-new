                    ...
                    <div className="row">
                      ...
                      <div className="col-md-5">
                        <div className="overflow-auto mt-4 md:mt-0">
                          <table className="table-fixed w-full border border-gray-300 text-xs">
                            <thead>
                              <tr>
                                <th className="border border-gray-300 px-2 py-2 truncate">
                                  {isTypeP ? 'Working_standard' : 'Absorbance'}
                                </th>
                                <th className="border border-gray-300 px-1 py-2 truncate">
                              ...
                              {labSettingData.laboratorySettingDetails?.map(
                                val => (
                                  ...
                                  >
                                    ...
                                    <td className="border border-gray-300 px-1 py-2 truncate text-center">
                                      {isTypeP
                                        ? val.absorbance
                                        : val.workingStandard}
                                    </td>
