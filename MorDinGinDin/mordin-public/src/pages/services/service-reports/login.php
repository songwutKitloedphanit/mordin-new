...
<section id="about-us" class="section about-us">
  <div class="container">
    <div class="row gy-4" style="text-align: center;">
      <div class="col-lg-8 order-1 order-lg-2 mt-2" style="text-align: center; align-content: center;" data-aos="fade-up" data-aos-delay="100">
        ...
        <form action="<?= htmlspecialchars($_SERVER['REQUEST_URI']) ?>" method="post" data-aos="fade-up" data-aos-delay="200">
          <div class="row gy-4 mt-2">

            <div class="d-flex gap-2 justify-content-center">
              <input type="radio" name="loginType" value="farmer_id" onclick="changePlaceholder('หมายเลขเกษตรกร')" required checked>
              <label class="me-3">หมายเลขเกษตรกร</label>
              <input type="radio" name="loginType" value="thai_id" onclick="changePlaceholder('หมายเลขบัตรประชาชน')" required>
              <label>หมายเลขบัตรประชาชน</label>
            </div>

            <div class="col-md-12">
              <input type="text" class="form-control" id="identifier" name="identifier" placeholder="หมายเลขเกษตรกร" required>
            </div>
            ...
            <div class="col-md-12 text-center">
              <button type="submit" class="btn btn-success btn-lg text-white" style="width:300px;">ลงชื่อเข้าใช้ระบบ</button>
            </div>
          </div>
        </form>
        ...
        <div class="row mt-2">
          <div class="col-md-12" style="left: 25%;">
            <a href="services/book/register" class="btn btn-warning btn-lg text-white" style="width:300px;">สมัครเพื่อรับบริการ</a>
          </div>
        </div>
      </div>
