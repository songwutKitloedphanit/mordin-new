...
export class BooksService {
  ...
  async getReports(sampleCodes: string[]): Promise<any[]> {
    ...
    const [
      ...
      // Query for Results
      this.resultRepo.createQueryBuilder('result')
      ...
      const html = `
          <html lang="en">
            ...
            <div class="table-label">
              ...
              <p>ระดับความอุดมสมบูรณ์: ${report.ferMajorLandScores.find(
        r => r.soilGrade.laboratoryId === null
            ...
            <div class="table-label">
              ...
              <table>
                ...
                ${report.ferMinorLandUsages.map(r => `<tr>
            ...
            <table border="1" cellspacing="0" cellpadding="4" style="border-collapse: collapse; width:100%;">
              <thead>
                <tr style="background-color: #cfe2ff;">
                  ...
                  ${report.serviceType?.serviceCategories.map(cat => `
              ...
              <tbody>
                ${report.usageType.map(usageType => {
  ...
  async generateSummaryReportByLandPdf(landSummary: any, res: Response) {
    ...
    const logoBase64 = fs.readFileSync(path.join(process.cwd(), 'src', 'assets', 'images', 'mitrphol_research.png')).toString('base64');
          ...
          <html lang="en">
            ...
            <div class="table-label">
              ...
              <table>
                ...
                `).join('') : `<tr><td colspan="${Math.max(years.length + 1, 1)}">ไม่มีรายการผลวิเคราะห์</td></tr>`}
                </tbody>
