CREATE TABLE "fertilizer_major_land_scores" ("fertilizer_major_land_score_id" SERIAL NOT NULL, "soil_grade_id" integer NOT NULL, "book_id" integer NOT NULL, "result_id" integer, "soil_grade_level_id" integer NOT NULL, "result_value" double precision, "comment" text, "comment_uid" integer, "updated_at" bigint NOT NULL, "updated_uid" integer NOT NULL, CONSTRAINT "soil_grade_book" UNIQUE ("soil_grade_id", "book_id"), CONSTRAINT "PK_d4b98e0e763f57304fde919fdfb" PRIMARY KEY ("fertilizer_major_land_score_id"));

CREATE TABLE "fertilizer_major_land_usages" ("fertilizer_major_land_usage_id" SERIAL NOT NULL, "service_fertilizer_major_usage_id" integer NOT NULL, "book_id" integer NOT NULL, "total_score_id" integer NOT NULL, "fertilizer_major_id" integer NOT NULL, "updated_at" bigint NOT NULL, "grade" integer NOT NULL, "grade_text" character varying(255), "formula" character varying(8), "use_rate" double precision, "cost_per_rai" double precision, CONSTRAINT "ser_fer_major_usage_book" UNIQUE ("service_fertilizer_major_usage_id", "book_id"), CONSTRAINT "PK_c50c8195a14cc115d0ce62937d6" PRIMARY KEY ("fertilizer_major_land_usage_id"));

CREATE TABLE "fertilizer_minor_land_usages" ("fertilizer_minor_land_usage_id" SERIAL NOT NULL, "service_fertilizer_minor_id" integer NOT NULL, "book_id" integer NOT NULL, "result_id" integer NOT NULL, "level" integer NOT NULL, "fertilizer_minor_id" integer NOT NULL, "result_value" double precision, "fertilizer_minor_name" character varying(255), "use_rate_per_rai" double precision, "total_usage" double precision, "price_per_rai" double precision, "total_price" double precision, "updated_uid" integer NOT NULL, "updated_at" bigint, CONSTRAINT "serv_fer_minor_book" UNIQUE ("service_fertilizer_minor_id", "book_id"), CONSTRAINT "PK_c12b41e49224ed39f68130feba7" PRIMARY KEY ("fertilizer_minor_land_usage_id"));

CREATE TABLE "fertilizer_major_land_usages_logs" ("inserted_at" bigint NOT NULL, "deleted_at" bigint, "fertilizerMajorLandUsageId" integer NOT NULL, "service_fertilizer_major_usage_id" integer NOT NULL, "book_id" integer NOT NULL, "total_score_id" integer NOT NULL, "fertilizer_major_id" integer NOT NULL, "grade" integer NOT NULL, "grade_text" character varying(255), "formula" character varying(8), "use_rate" double precision, "cost_per_rai" double precision, CONSTRAINT "PK_9a7a47680318069b0f139f8e848" PRIMARY KEY ("inserted_at", "fertilizerMajorLandUsageId"));

CREATE TABLE "fertilizer_minor_land_usages_logs" ("inserted_at" bigint NOT NULL, "deleted_at" bigint, "fertilizerMinorLandUsageId" integer NOT NULL, "service_fertilizer_minor_id" integer NOT NULL, "book_id" integer NOT NULL, "result_id" integer NOT NULL, "level" integer NOT NULL, "fertilizer_minor_id" integer NOT NULL, "result_value" double precision, "fertilizer_minor_name" character varying(255), "use_rate_per_rai" double precision, "total_usage" double precision, "price_per_rai" double precision, "total_price" double precision, "updated_uid" integer NOT NULL, CONSTRAINT "PK_276c517c29c29cb6ce1a46c4a45" PRIMARY KEY ("inserted_at", "fertilizerMinorLandUsageId"));

CREATE TABLE "fertilizer_major_land_scores_logs" ("inserted_at" bigint NOT NULL, "deleted_at" bigint, "fertilizerMajorLandScoreId" integer NOT NULL, "soil_grade_id" integer NOT NULL, "book_id" integer NOT NULL, "result_id" integer, "soil_grade_level_id" integer NOT NULL, "result_value" double precision, "comment" text, "comment_uid" integer, "updated_uid" integer NOT NULL, CONSTRAINT "PK_3c2a5909f9f30058955c924d458" PRIMARY KEY ("inserted_at", "fertilizerMajorLandScoreId"));
