...
# Mordin Backend Deployment Script
...
REMOTE_PATH="~/mordin-backend"

ARCHIVE_NAME="mordin-backend.tar.gz"
TEMP_DIR="./temp"
...
main() {
    log_info "=== Mordin Backend Deployment Started ==="
    ...
    if tar czf "${TEMP_DIR}/${ARCHIVE_NAME}" dist node_modules package.json migrations scripts DB_MIGRATIONS.md; then
