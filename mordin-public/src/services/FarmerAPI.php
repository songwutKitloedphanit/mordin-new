...
class FarmerAPI
{
     ...
     */
    public static function publicLogin($phone, $birthDate)
    {
    ...
    public static function publicLookupByNamePhone($firstName, $phoneNumber)
    {
        ...
        return ['success' => false, 'message' => $result['message'] ?? 'ไม่พบข้อมูล'];
    }
    ...
    public static function registerFarmer($data)
    {
        ...
        // Backend
        //
        $url = self::getBaseUrl() . 'farmers/public-register';
