                      ...
                      <tbody>
                        {data.map((item, _index) => {
                          ...
                          groupByRepeat.forEach((results, repeatNumber) => {
                            ...
                            rows.push(
                              <tr
                                key={`${item.analysisStandardId}-${repeatNumber}`}
                              >
                                <td
                                  className="text-left"
                                  style={{ minWidth: '10vh' }}
                                ...
                                {columns?.map(col => {
                                  const result = results.find(
                                    r =>
                                      r.laboratorySetting?.laboratoryId ===
                                      col.laboratoryId
                                  );
                                  ...
                                  <div className="d-flex justify-content-center gap-2">
                                    <div className="p-0">
                                      <GenButtonCircle
                                        ...
                                        icon="fa fa-edit"
                                        onClick={() =>
                                          openEditModal(sampleCode, results)
                                        }
                                      />
                                    </div>
                                    <div>
                                      <GenButtonCircle
                                        ...
                                        onClick={() =>
                                          handlePrint(sampleCode, results)
                                        }
                                      />
                                    </div>
                                  </div>
                                ...
                                <input
                                  ...
                                  onChange={e => {
                                    ...
                                    setEditedResults(prev =>
                                      prev.map(r =>
                                        r.analysisStandardResultId ===
                                        result.analysisStandardResultId
                                          ? {
                                              ...r,
