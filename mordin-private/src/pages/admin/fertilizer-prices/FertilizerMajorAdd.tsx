...
const createDefaultFertilizerMajorInput = (): FertilizerMajorInput => ({
  type: FertilizerMajorTypes.Foliar,
  N: null,
  P: null,
  K: null,
  quantity: null,
...
const FertilizerMajorAdd: React.FC = () => {
  ...
  const [formData, setFormData] = useState<FertilizerMajorInput>(
    createDefaultFertilizerMajorInput()
  );
    ...
    const fetchUnits = async () => {
      try {
        ...
        if (data.length > 0) {
          setFormData(prev => ({
            ...prev,
            unitId: prev.unitId ?? data[0].unitId,
          }));
        }
      } catch (err) {
        ...
        <div className="col-md-12">
          <div className="private-card">
            <div className="private-card-header d-flex justify-content-between align-items-center">
              <h4 className="private-card-title mb-0">เพิ่มปุ๋ยหลัก</h4>
              <GenButtonCircle
